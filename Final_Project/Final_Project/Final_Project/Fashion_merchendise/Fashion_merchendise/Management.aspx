<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Management.aspx.cs" Inherits="Fashion_merchendise.Management" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="product_id" DataSourceID="SqlDataSource1" Height="176px" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None">
            ...
            <asp:TemplateField HeaderText="Version" SortExpression="product_price">
                <EditItemTemplate>
